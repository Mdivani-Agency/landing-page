  ...
  return (
    <>
      ...
      {otherFeatured.length > 0 ? (
        <Section
          labelledBy="more-featured-posts-heading"
          className="mt-8 lg:mt-16"
        >
          <h2
            id="more-featured-posts-heading"
            className="mb-1.5 text-xs uppercase tracking-caps text-secondary"
          >
            More featured posts
          </h2>
          <div className="grid gap-2">
            {otherFeatured.map((featuredPost) => (
              <BlogPostCard key={featuredPost.slug} post={featuredPost} />
            ))}
          </div>
        </Section>
      ) : null}
